        ...
        <section id="services" className="gap-y-20 bg-white py-16">
          <div className="container mx-auto px-4">
            <div className="text-center max-w-3xl mx-auto mb-20">
              <span className="text-brand-teal font-medium text-4xl uppercase tracking-wider mb-3 inline-block">Our Services</span>
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
              {[
                ...
                <div key={index} className="bg-gradient-to-br from-gray-50 to-white p-8 rounded-xl shadow-[0_4px_20px_rgba(0,0,0,0.03)] border border-gray-100 hover:border-brand-teal/30 transition-all duration-300 hover:-translate-y-1">
                  <div className="bg-brand-teal/10 w-20 h-20 rounded-full flex items-center justify-center mb-6">
                    <div className="text-brand-teal text-4xl">•</div>
                  </div>
            ...
            <div className="mt-20 bg-gradient-to-r from-brand-blue to-blue-800 rounded-2xl p-12 text-center">
