  ...
  return (
    <div className="min-h-screen bg-background">
      <Helmet>
        ...
        <meta
          name="description"
          content="Explore our comprehensive virtual assistant services including customer support, technical support, web development, digital marketing, and more. Designed to help your business grow."
        />
          ...
          <div className="container mx-auto px-4 relative z-10">
            <div className="max-w-4xl mx-auto text-center text-white">
              ...
              <p className="text-xl md:text-2xl mb-8 text-white/90 animate-fade-in max-w-3xl mx-auto">
                From virtual assistants to technical support, we provide a complete range of services to help your business thrive
              </p>
            </div>
          </div>
        </section>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                {services.map((service, index) => {
                  ...
                  return (
                    <Card
                      key={index}
                      className="group overflow-hidden border-2 border-gray-100 hover:border-brand-teal hover:shadow-2xl transition-all duration-500 hover:-translate-y-2"
                    >
                  ...
                  <div className="bg-gradient-to-br from-brand-blue via-brand-teal to-brand-blue p-12 text-center relative overflow-hidden">
                    ...
                    <div className="relative z-10">
                      ...
                      <p className="text-xl text-white/90 mb-8 max-w-2xl mx-auto">
                        We can tailor our services to match your specific business requirements. Let's discuss how we can help you scale efficiently.
                      </p>

                      <div className="flex flex-col sm:flex-row gap-4 justify-center">
                        <Button
                          className="bg-white text-brand-blue hover:bg-gray-100 px-8 py-6 text-lg font-semibold"
                          onClick={() => window.open("https://www.primevsolutions.com", "_blank")}
                        >
