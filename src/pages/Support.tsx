            ...
            <div className="mb-16">
              ...
              <Accordion type="single" collapsible className="w-full">
                <AccordionItem value="item-1">
                  ...
                  <AccordionContent>
                    ShiftNex AI uses advanced artificial intelligence algorithms to analyze your skills, preferences,
                    location, and availability. It then compares these factors with available shifts to find optimal
                    matches. The system continues to learn from your feedback to improve matches over time.
                  </AccordionContent>
                </AccordionItem>
                ...
                <AccordionItem value="item-2">
                  ...
                  <AccordionContent>
                    Log in to your ShiftNex account, navigate to your profile settings, and select "Credentials" from
                    the menu. From there, you can upload new documents, update existing ones, and manage your credential
                    verification status.
                  </AccordionContent>
                </AccordionItem>
                ...
                <AccordionItem value="item-3">
                  ...
                  <AccordionContent>
                    Yes! ShiftNex AI is designed to work with your schedule. In your account settings, you can specify
                    your available days and hours, set recurring availability patterns, and mark specific dates as
                    unavailable for personal time.
                  </AccordionContent>
                </AccordionItem>
                ...
                <AccordionItem value="item-4">
                  ...
                  <AccordionContent>
                    Once your profile is complete and your credentials are verified, you can begin receiving shift
                    matches immediately. The verification process typically takes 24-48 hours, and our team works to
                    expedite this process whenever possible.
                  </AccordionContent>
                </AccordionItem>
                ...
                <AccordionItem value="item-5">
                  ...
                  <AccordionContent>
                    ShiftNex processes payments securely through our integrated payment system. You can set up direct
                    deposit in your account settings. Payments are processed on a weekly basis, and you can track all
                    your earnings in your personal dashboard.
                  </AccordionContent>
                </AccordionItem>
              </Accordion>
            </div>
