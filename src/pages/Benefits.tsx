...
const Benefits = () => {
  ...
  const statistics = [
    { value: "95%", label: "Client Satisfaction Rate", icon: Heart },
    { value: "60%", label: "Average Cost Savings", icon: CreditCard },
    { value: "24/7", label: "Support Availability", icon: Clock },
    { value: "500+", label: "Skilled Professionals", icon: Users }
  ];
  ...
  return (
    <div className="min-h-screen bg-background">
      <Helmet>
        ...
        <meta
          name="description"
          content="Discover the benefits of working with Prime Virtual Solutions: 60% cost savings, 24/7 support, scalable solutions, and expert virtual assistants for your business."
        />
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                {benefits.map((benefit, index) => {
                  ...
                  return (
                    <Card
                      key={index}
                      className="group border-2 border-gray-100 hover:border-brand-teal hover:shadow-xl transition-all duration-300 hover:-translate-y-2"
                    >
            ...
            <div className="max-w-6xl mx-auto">
              ...
              <div className="grid md:grid-cols-3 gap-8">
                {caseStudies.map((study, index) => (
                  <Card key={index} className="border-t-4 border-t-brand-teal hover:shadow-xl transition-all duration-300">
