          ...
          <div className="container mx-auto px-4">
            <div className="max-w-4xl mx-auto text-center">
              ...
              <p className="text-lg text-gray-600 mb-8">
                We don't just provide virtual assistants—we provide industry-specific professionals who understand your business challenges, regulations, and best practices. This means faster onboarding, better results, and solutions that truly fit your needs.
              </p>
              <div className="grid md:grid-cols-2 gap-8 text-left">
                <div className="bg-white p-6 rounded-lg shadow-sm">
                  <h3 className="text-xl font-bold text-gray-900 mb-3">Compliance-Ready</h3>
                  <p className="text-gray-600">Our team is trained in industry-specific regulations, from HIPAA for healthcare to data privacy laws for e-commerce.</p>
                </div>
                <div className="bg-white p-6 rounded-lg shadow-sm">
                  <h3 className="text-xl font-bold text-gray-900 mb-3">Domain Knowledge</h3>
                  <p className="text-gray-600">Virtual assistants with experience in your industry hit the ground running, understanding terminology and workflows from day one.</p>
                </div>
                <div className="bg-white p-6 rounded-lg shadow-sm">
                  <h3 className="text-xl font-bold text-gray-900 mb-3">Best Practices</h3>
                  <p className="text-gray-600">We apply proven methodologies and tools specific to your sector, ensuring optimal efficiency and results.</p>
                </div>
                <div className="bg-white p-6 rounded-lg shadow-sm">
                  <h3 className="text-xl font-bold text-gray-900 mb-3">Scalable Solutions</h3>
                  <p className="text-gray-600">Whether you're a startup or enterprise, our solutions scale with your business growth and changing needs.</p>
                </div>
              </div>
            </div>
          </div>
