...
const Careers = () => {
  ...
  return <div className="min-h-screen bg-background flex flex-col">
      ...
      <main className="flex-grow pt-24 pb-16">
        ...
        <section id="open-positions" className="bg-gray-50 mb-[20px] py-[20px]">
          <div className="container mx-auto px-4">
            <div className="max-w-6xl mx-auto">
              <div className="text-center mb-16">
              ...
              <div className="text-center">
                <Card className="inline-block bg-gradient-to-r from-brand-teal to-brand-blue text-white">
                  <CardContent className="p-8">
                    ...
                    <Button onClick={handleApplyNow} className="bg-white/10 backdrop-blur-sm text-white border-2 border-white hover:bg-white hover:text-brand-blue px-8 py-4 text-lg font-bold transition-all shadow-lg hover:shadow-xl rounded-lg">
        ...
        <section className="pt-[40px] pb-[30px] bg-gradient-to-br from-brand-blue to-brand-teal text-white mb-[20px]">
          <div className="container mx-auto px-4">
