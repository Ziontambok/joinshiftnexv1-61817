    ...
    <footer className="bg-gray-50 pt-16 pb-8">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
          ...
          <div>
            <h3 className="text-lg font-bold text-shiftnex-deep-blue mb-4">Quick Links</h3>
            <ul className="space-y-3">
              <li>
                <Link to="/#about" className="text-gray-600 hover:text-shiftnex-teal transition-colors">
                  About
                </Link>
              </li>
              <li>
                <Link to="/#services" className="text-gray-600 hover:text-shiftnex-teal transition-colors">
                  Services
                </Link>
              </li>
              <li>
              ...
              <li>
                <Link to="/#benefits" className="text-gray-600 hover:text-shiftnex-teal transition-colors">
                  Benefits
                </Link>
              </li>
              <li>
                <Link to="/careers" className="text-gray-600 hover:text-shiftnex-teal transition-colors">
                  Careers
                </Link>
              </li>
              <li>
          ...
          <div>
            <h3 className="text-lg font-bold text-shiftnex-deep-blue mb-4">Legal</h3>
            <ul className="space-y-3">
              <li>
                <Link to="/privacy-policy" className="text-gray-600 hover:text-shiftnex-teal transition-colors">
                  Privacy Policy
                </Link>
              </li>
              <li>
                <Link to="/terms-of-service" className="text-gray-600 hover:text-shiftnex-teal transition-colors">
                  Terms of Service
                </Link>
              </li>
              <li>
                <Link to="/cookie-policy" className="text-gray-600 hover:text-shiftnex-teal transition-colors">
                  Cookie Policy
                </Link>
              </li>
            </ul>
          ...
          <div>
            ...
            >
              <input 
                ...
                className="px-4 py-2 border border-gray-300 rounded-l-md focus:outline-none focus:ring-2 focus:ring-shiftnex-teal focus:border-transparent flex-grow"
              />
              <button className="bg-shiftnex-teal text-white px-4 py-2 rounded-r-md hover:bg-opacity-90 transition-colors">
                <Mail size={20} />
              </button>
            </form>
            <div className="mt-4">
