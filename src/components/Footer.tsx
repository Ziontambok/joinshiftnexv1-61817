...
const Footer = ({ className }: { className?: string }) => {
  return (
    <footer className="bg-gray-50 pt-[20px] pb-8">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
          <div>
            <div className="flex items-center gap-3 mb-4">
              <img src="/images/footer-logo.png" alt="Prime Virtual Solutions Logo" className="h-12" />
              <span className="text-xl font-bold text-brand-blue">Prime Virtual Solutions</span>
            </div>
            <p className="text-gray-600 mb-6">
              Professional virtual assistant and call center services helping businesses scale efficiently with 24/7
              support and expert remote professionals.
            </p>
            <div className="flex space-x-4">
              <a
                href="https://www.facebook.com/PrimeVSolutions"
                target="_blank"
          ...
          <div>
            ...
            <p className="text-gray-600 mb-4">Stay updated on the latest in virtual assistant services.</p>
            <form
              className="flex"
              onSubmit={(e) => {
                e.preventDefault();
