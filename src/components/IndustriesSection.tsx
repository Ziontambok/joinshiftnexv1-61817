...
const industries = [
  {
    ...
    title: "E-commerce",
    description:
      "Order processing, customer support, inventory management, and product listing assistance for online stores.",
  ...
  },
  {
    ...
    title: "Real Estate",
    description:
      "Lead qualification, appointment scheduling, client follow-ups, and transaction coordination for agencies.",
  ...
  },
  {
    ...
    description:
      "Legal document preparation, client intake, case management, and administrative support for law firms.",
  ...
  },
  {
    ...
    description:
      "Patient scheduling, insurance verification, billing support, and medical records management (non-clinical).",
