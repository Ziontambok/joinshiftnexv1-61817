...
const IndustriesSection = () => {
  return <section id="industries" className="py-24 bg-gradient-to-b from-gray-50 to-white">
      <div className="container mx-auto px-4">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          {industries.map((industry, index) => <div key={index} className="bg-white p-8 rounded-xl shadow-[0_4px_20px_rgba(0,0,0,0.03)] border border-gray-100 hover:border-brand-teal/30 transition-all duration-300 hover:-translate-y-1 reveal" style={{
          animationDelay: `${index * 0.1}s`
              ...
              <div className="border-t border-gray-200 pt-4">
                ...
                <ul className="space-y-2">
                  {industry.services.map((service, idx) => <li key={idx} className="text-sm text-gray-600 flex items-center justify-center">
        ...
        <div className="mt-16 text-center bg-gradient-to-r from-soft-teal/10 to-soft-blue/10 rounded-2xl p-8 max-w-4xl mx-auto reveal">
          ...
          <p className="text-gray-600 mb-6">We work with Enterprimes and SMEs across many sectors. Contact us to discuss how our virtual assistants can support your specific business needs.</p>
